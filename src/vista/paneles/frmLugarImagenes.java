...
import Interfaz.Principales.Principal;
...
public class frmLugarImagenes extends JPanel  {

    private byte[] imagen;
    private File abre;
    private DefaultListModel listModel = new DefaultListModel();
    
    public frmLugarImagenes(Principal p) {
        initComponents();
    ...
    private void lblIMGMouseClicked(MouseEvent e) {
        ...
        if (abre != null) {
            ...
            try {
                ...
                Logger.getLogger(frmLugarImagenes.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
