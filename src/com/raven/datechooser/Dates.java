...
//                    cmd.setForeground(new java.awt.Color(75, 75, 75));
    ...
    private void initComponents() {
        ...
        cmdSu.setText("Do");
        cmdSu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdSuActionPerformed(evt);
            }
        });
        add(cmdSu);
    ...
    private void cmdSuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmdSuActionPerformed
